...
class AppUtils {
    ...
    **/
    notifyOfDueDate(_a) {
        return __awaiter(this, arguments, void 0, function* ({ item, daysBefore, message = `Item is due` }) {
    ...
    **/
    notifyAssigned(_a) {
        return __awaiter(this, arguments, void 0, function* ({ item, message = 'New Task Assigned' }) {
